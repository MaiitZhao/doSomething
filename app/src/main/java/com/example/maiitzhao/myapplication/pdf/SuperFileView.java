...
/**
 * Created by maiitzhao on 2018/12/4.
 */
...
public class SuperFileView extends FrameLayout implements TbsReaderView.ReaderCallback {
    ...
    public void displayFile(File mFile) {
        ...
        if (mFile != null && !TextUtils.isEmpty(mFile.toString())) {
            ...
            if (!bsReaderTempFile.exists()) {
                Log.e("log", "准备创建/storage/emulated/0/TbsReaderTemp！！");
                boolean mkdir = bsReaderTempFile.mkdir();
                if (!mkdir) {
                    Log.e("log", "创建/storage/emulated/0/TbsReaderTemp失败！！！！！");
                }
            }

            //加载文件
            Bundle localBundle = new Bundle();
            Log.e("log", mFile.toString());
    ...
    private String getFileType(String paramString) {
        ...
        if (TextUtils.isEmpty(paramString)) {
            Log.e("log", "paramString---->null");
            return str;
        }
        Log.e("log", "paramString:" + paramString);
        ...
        Log.e("log", "paramString.substring(i + 1)------>" + str);
        return str;
    }
